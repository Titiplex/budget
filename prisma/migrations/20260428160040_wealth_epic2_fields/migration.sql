...
INSERT INTO "new_Account" ("createdAt", "currency", "description", "id", "name", "type", "updatedAt") SELECT "createdAt", "currency", "description", "id", "name", "type", "updatedAt" FROM "Account";
DROP TABLE "Account";
...
INSERT INTO "new_Transaction" ("accountId", "amount", "categoryId", "conversionMode", "createdAt", "date", "exchangeDate", "exchangeProvider", "exchangeRate", "id", "kind", "label", "note", "sourceAmount", "sourceCurrency", "updatedAt") SELECT "accountId", "amount", "categoryId", "conversionMode", "createdAt", "date", "exchangeDate", "exchangeProvider", "exchangeRate", "id", "kind", "label", "note", "sourceAmount", "sourceCurrency", "updatedAt" FROM "Transaction";
